...
public class SeekBar extends View {
    ...
    private void initXMLAttrs(Context context, AttributeSet attrs) {
        ...
        setEnabled(a.getBoolean(R.styleable.SeekBar_enabled, true));
        setProgress(a.getInt(R.styleable.SeekBar_start_progress, 1));
        setLabel(a.getString(R.styleable.SeekBar_label));

        setBackCircleColor(a.getColor(R.styleable.SeekBar_back_circle_color, backCircleColor));
        setMainCircleColor(a.getColor(R.styleable.SeekBar_main_circle_color, mainCircleColor));
        setIndicatorColor(a.getColor(R.styleable.SeekBar_indicator_color, indicatorColor));
        setProgressPrimaryColor(a.getColor(R.styleable.SeekBar_progress_primary_color, progressPrimaryColor));
        setProgressSecondaryColor(a.getColor(R.styleable.SeekBar_progress_secondary_color, progressSecondaryColor));

        setBackCircleDisabledColor(a.getColor(R.styleable.SeekBar_back_circle_disable_color, backCircleDisabledColor));
        setMainCircleDisabledColor(a.getColor(R.styleable.SeekBar_main_circle_disable_color, mainCircleDisabledColor));
        setIndicatorDisabledColor(a.getColor(R.styleable.SeekBar_indicator_disable_color, indicatorDisabledColor));
        setProgressPrimaryDisabledColor(a.getColor(R.styleable.SeekBar_progress_primary_disable_color, progressPrimaryDisabledColor));
        setProgressSecondaryDisabledColor(a.getColor(R.styleable.SeekBar_progress_secondary_disable_color, progressSecondaryDisabledColor));

        setLabelSize(a.getDimension(R.styleable.SeekBar_label_size, (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP,
                labelSize, getResources().getDisplayMetrics())));
        setLabelColor(a.getColor(R.styleable.SeekBar_label_color, labelColor));
        setlabelDisabledColor(a.getColor(R.styleable.SeekBar_label_disabled_color, labelDisabledColor));
        setLabelFont(a.getString(R.styleable.SeekBar_label_font));
        setLabelStyle(a.getInt(R.styleable.SeekBar_label_style, 0));
        setIndicatorWidth(a.getFloat(R.styleable.SeekBar_indicator_width, 7));
        setIsContinuous(a.getBoolean(R.styleable.SeekBar_is_continuous, false));
        setProgressPrimaryCircleSize(a.getFloat(R.styleable.SeekBar_progress_primary_circle_size, -1));
        setProgressSecondaryCircleSize(a.getFloat(R.styleable.SeekBar_progress_secondary_circle_size, -1));
        setProgressPrimaryStrokeWidth(a.getFloat(R.styleable.SeekBar_progress_primary_stroke_width, 25));
        setProgressSecondaryStrokeWidth(a.getFloat(R.styleable.SeekBar_progress_secondary_stroke_width, 10));
        setSweepAngle(a.getInt(R.styleable.SeekBar_sweep_angle, -1));
        setStartOffset(a.getInt(R.styleable.SeekBar_start_offset, 30));
        setMax(a.getInt(R.styleable.SeekBar_max, 25));
        setMin(a.getInt(R.styleable.SeekBar_min, 1));
        deg = min + 2;
        setBackCircleRadius(a.getFloat(R.styleable.SeekBar_back_circle_radius, -1));
        setProgressRadius(a.getFloat(R.styleable.SeekBar_progress_radius, -1));
        setAntiClockwise(a.getBoolean(R.styleable.SeekBar_anticlockwise, false));
        a.recycle();
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (mSeekBarChangeListener != null)
            mSeekBarChangeListener.onProgressChanged(this, (int) (deg - 2));
    ...
    public boolean onTouchEvent(MotionEvent e) {
        ...
        if (Utils.getDistance(e.getX(), e.getY(), midx, midy) > Math.max(mainCircleRadius, Math.max(backCircleRadius, progressRadius))) {
            if (startEventSent && mSeekBarChangeListener != null) {
