package com.parthjadav.passwordmanager.biometric;
...
public class BiometricDialogV23 extends BottomSheetDialog implements View.OnClickListener {
    ...
    private void setDialogView() {
        View bottomSheetView = getLayoutInflater().inflate(R.layout.view_bottom_sheet_biometric, null);
    ...
    public void setLogo(Bitmap imageLogo) {
